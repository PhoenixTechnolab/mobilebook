...
export default {
  ...
  CheckboxBorderWidth: platform === PLATFORM.IOS ? 2 : 2,
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? 'rgba(0,0,0,1)' : 'rgba(0,0,0,1)',
  colorAscent: '#DBCB0E',
  brandInfo: '#62B1F6',
  brandSuccess: colors.success,
  brandDanger: colors.error,
  brandWarning: '#f0ad4e',
  brandDark: '#000',
  brandLight: '#f4f4f4',
  ...
  activeTab: platform === PLATFORM.IOS ? colors.primary : '#fff',
  sTabBarActiveTextColor: colors.primary,
  tabBarActiveTextColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  ...
  listItemSelected: platform === PLATFORM.IOS ? colors.primary : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? colors.primary : '#fff',
